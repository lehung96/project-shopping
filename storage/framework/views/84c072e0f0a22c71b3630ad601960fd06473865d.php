        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-xs-12 col-lg-6 mb-30 offset-3">
                    ...
                    <form action="<?php echo e(URL::to('/reset-new-pass')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="login-form" >
                            ...
                            <div class="row">
                                <div class="col-md-12 col-12 mb-20">
                                    ...
                                    <input class="mb-0" type="hidden" name="email"  value="<?php echo e($email); ?>"/>
                                </div>
                                <div class="col-md-12 col-12 mb-20">
                                    
                                    <input class="mb-0" type="hidden" name="token"  value="<?php echo e($token); ?>"/>
                                </div>
                                <div class="col-md-12 col-12 mb-20">
...
<?php /**PATH D:\xampp\htdocs\shopping-Houseware\resources\views/pages/checkout/new_pass.blade.php ENDPATH**/ ?>