<head>
    ...
    <meta name="keywords" content="<?php echo e($meta_keywords); ?>"/> <!--từ khóa gợi nhớ để khách hàng search để tìm thế trang website gia dụng -->
    <meta name="robots" content="INDEX,FOLLOW"/>
    <link  rel="canonical" href="<?php echo e($url_canonical); ?>" /><!-- thẻ này dùng để chia sẽ trang web
    mình lên các trang mạng xã hội ;thì mặc định sẽ lấy được đường link hiện tại -->
    <meta name="author" content="">
    <!-- icon bên cạnh tab hiển thị google -->
    <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(asset('public/frontend/images/favicon.png')); ?>">
...
<?php /**PATH D:\xampp\htdocs\shopping-Houseware\resources\views/fronted/head.blade.php ENDPATH**/ ?>