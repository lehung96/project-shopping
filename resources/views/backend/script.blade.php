...
{{--Sử sụng thư viện Jquery  dùng Datepicker(đe pic cơ) jquery thêm lịch --}}
...
{{-- hàm   $(document).ready(function() này nhận giá trị trả về hàm
 $('.dashboard-filter').change(function() giá trị trả về kiểu
 JSON key value để in ra biểu đồ--}}


{{--price_format giá tiền khi nhập  --}}
<script type="text/javascript">
...
{{--ajax thông kê doanh số đơn hàng  --}}
<script type="text/javascript">
...
{{--Thống kê truy cập tổng bài viết , số lượng , cũng như đơn hàng
biểu đồ Morris chart donut example--}}
<script type="text/javascript">
    $(document).ready(function(){
...
{{--Sử dụng ajax update select trạng thái đơn hàng (order_status)
dựa vào class order_detail--}}
<script type="text/javascript">
    {{--gọi class order_details bên form select
    .change nghĩa là  có thay đổi lựa chọn (select)--}}
    $('.order_details').change(function(){
        ...
        {{--trong form có  @csrf là token để kiểm tra chống bảo mật   --}}
        var _token = $('input[name="_token"]').val();
      ...
      // có name là name="product_sales_quantity"-->
        ...
        for(i=0;i<order_product_id.length;i++){
            ...
            {{--//biến var order_qty là số lượng khách đặt = cái  class="order_qty_{{$details->product_id}}" khai báo bên input --}}
...
{{--<!--script dùng để xử lý việc thêm ảnh  -->--}}
{{--<script type="text/javascript">--}}
{{--    <!-- load_gallery() dùng để chạy câu lệnh trong function load_gallery()  -->--}}
{{--    load_gallery();--}}
{{--    //hàm function load_gallery() load ra danh sách hình ảnh--}}
{{--    function load_gallery(){--}}

{{--       // .pro_id là lấy đố tượng class bên phía <input type="hidden" value="" name="pro_id" class="pro_id"> bên file add_gallery--}}
{{--        var pro_id = $('.pro_id').val();--}}
{{--        var _token = $('input[name="_token"]').val();--}}
{{--        alert(pro_id);--}}

{{--        //gửi ajax qua để vào table gallery lấy những hình ảnh dựa trên product_id--}}
{{--        $.ajax({--}}
{{--            //đầu tiên gửi = url trước--}}
{{--            url:"{{url('/select-gallery')}}",--}}
{{--            //gửi bằng phương thức post--}}
{{--            method:"POST",--}}
{{--            data:{pro_id:pro_id,_token:_token},--}}
{{--            //success là khi thành công load dữ liệu ( load table gallery)--}}
{{--            success:function(data){--}}
{{--                $('#gallery_load').html(data);--}}
{{--            }--}}
{{--        });--}}
{{--    }--}}
{{--      //bắt sự kiện chọn ảnh id="file" trong thẻ <input> bên add_gallery--}}
{{--    //.change có nghĩ là chọn ảnh--}}
{{--    //Hàm xử lý thêm hình ảnh--}}
{{--    $('#file').change(function(){--}}
{{--        var error = ''; // khởi tạo biến error bằng rỗng--}}
{{--        // var files = ảnh ($('#file') bắt id="file" là ảnh chọn trong tập tin--}}
{{--        //[0] là ấy là ảnh đầu tiên (lưu dưới dạng mảng )--}}
{{--        var files = $('#file')[0].files;--}}
{{--        // kiểm tra chiều dài cho tối da 5 ảnh cho một lần upload--}}
{{--        if(files.length>5){// nếu files ảnh ảnh số lượng lớn hơn 5--}}
{{--            // thì in ra thống báo--}}
{{--            error+='<p>Bạn chọn tối đa chỉ được 5 ảnh</p>';--}}
{{--            // kiểm tra files.length=='' khô được để rỗng--}}
{{--        }else if(files.length==''){--}}
{{--            error+='<p>Bạn không được bỏ trống ảnh</p>';--}}
{{--            // kiểm tra khích thước ảnh không qúa 2MB (2 triệu)--}}
{{--        }else if(files.size > 2000000){--}}
{{--            error+='<p>File ảnh không được lớn hơn 2MB</p>';--}}
{{--        }--}}

{{--        if(error==''){// nếu error chải qua 3 bước trên = rỗng  thì o làm gì--}}

{{--        }else{// ngược  lại thì--}}
{{--            $('#file').val('');//xuất hiện lỗi song trở lại ko có tệp nào được chọn--}}
...
{{--        //xóa bắt  data-gal_id  và data-gal_id chứa gallery_id cần xóa <button data-gal_id="'.$gal->gallery_id bên phía nốt button--}}
{{--        var gal_id = $(this).data('gal_id');--}}
...
{{--        }--}}
{{--    });--}}
{{--// hàm này xử lý cập nhật hình ảnh ( thay đổi hình ảnh )--}}
{{--    //.file_image là bắt được khi người dùng click thực hiện lệnh ajax thì mang cái id của hình ảnh đó--}}
...
{{-- sử dụng câu lệnh Jquery bắt sự kiện bằng id  id="inputname" bên form add thuộc tính --}}
<script type="text/javascript">
    ...
    $('#inputName').change(function(event){
       ...
       var _input =  $('#inputName').val();//.val(); lầ lấy ra giá trị value ở class = value1  value2 value3
        ...
        if (_input=='DUNG TÍCH NỒI') {
            ...
            {{-- ngược lại else ì hoặc nếu _input== 'brand' --}}
