                        ...
                        <form role="form" action="{{URL::to('/update-post/'.$post->post_id)}}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="post_title" data-validation="length"
                                       ...
                                       onkeyup="ChangeToSlug();" value="{{$post->post_title}}" id="slug"
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="resize: none" rows="8" class="form-control" name="post_desc"
                                          id="summernotes2" placeholder="Mô tả danh mục">{{$post->post_desc}}</textarea>
                            </div>
                                ...
                                <div class="card card-outline card-info">
                                    ...
                                    <div class="card-body">
                                         <textarea style="resize: none" rows="8" class="form-control" name="post_content"
                                                   id="summernotes1" placeholder="Mô tả danh mục">{{$post->post_content}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="cate_post_id" class="form-control input-sm m-bot15">
                                    @foreach($cate_post as $key => $cate)
                                        <option
                                            {{$post->cate_post_id==$cate->cate_post_id ? 'selected' : ''}} value="{{$cate->cate_post_id}}">{{$cate->cate_post_name}}</option>
                                    @endforeach
