...
@section('main_content')
    <div class="content-wrapper">
        ...
        @include('backend.content-header', ['name' => ' Liệt kê  ', 'key' => 'bình luận'])
                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-striped b-t b-light" id="myTable">
                        ...
                        @foreach($comment as $key => $comm)
                            {{--            @php  dd($comm->product->product_slug); @endphp--}}
                            <tr>
                                ...
                                <td>{{ $comm->comment }}
                                    ...
                                    @if($comm->comment_status==0)
                                        ...
                                        <button class="btn btn-default btn-xs btn-reply-comment"
                                                ...
                                                data-comment_id="{{$comm->comment_id}}">Trả lời bình luận
                                        </button>
                                ...
                                <td><a href="{{route('products-detail-view',['product_id'=>$comm->product_id])}}"
                                       target="_blank">{{ $comm->product_name }}</a></td>
