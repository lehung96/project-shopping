...
<div class="login-box">
    ...
    <div class="card">
        <div class="card-body login-card-body">
            ...
            {{--// gử đến cái hàm admin-dashboard nó sẽ lấy email và pas sau đó sẽ--}}
            {{--//so sánh với bảng tbl_admin--}}
{{--            {{ Form::open(array('url' => 'login')) }}--}}
            <form action="{{URL::to('/admin-login')}}" method="post">
               @csrf {{--//  {{csrf_field()}} giúp bảo mật khi chúng ta gửi dữ liệu từ form lên--}}
