...
@section('main_content')
    <div class="content-wrapper">
        <div class="row" style="margin-top: 5px;margin-bottom: 5px">
            <div class="col-md-12">
                <form action="{{ route('search.code') }}" method="get" class="form-inline" style=" padding-left: 15px">
...
{{--                                    <td><i>{{$i}}</i></label></td>--}}
                                    ...
                                    <td>
                                        ...
                                        <a onclick="return confirm('Bạn có chắc là muốn xóa đơn hàng này ko?')" href="{{ route('delete.order',$order->order_code) }}"
