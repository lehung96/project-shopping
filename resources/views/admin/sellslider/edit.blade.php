...
@section('main_content')
    <div class="content-wrapper">
        @include('backend.content-header', ['name' => 'ảnh sản phẩm', 'key' => 'sửa'])
                    ...
                    <div class="row">
                        <div class="col-md-6 offset-3">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="{{$slider->price}}" name="price" class="form-control price_format" id="exampleInputEmail1" >
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1">Giảm giá </label>
                                <input type="text" value="{{$slider->discount}}" name="discount" class="form-control price_format" id="exampleInputEmail1" >
                            </div>
                            <div class="form-group">
