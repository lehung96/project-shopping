...
@section('main_content')
    ...
    <div class="content-wrapper">
        ...
        ?>
        <form action="{{ route('sellslider.store') }}" method="post" enctype="multipart/form-data">{{--đã upload ảnh thêm thuộc tính enctype="multipart/form-data"--}}
            <div class="content">
