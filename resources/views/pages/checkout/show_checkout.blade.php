...
{{--                    <form action="{{URL::to('/save-checkout-customer')}}" method="post">--}}
                    <form method="POST">
                        ...
                        <div class="checkbox-form">
                            <h4><i style="color: #479bf3" class="fa fa-map-marker"></i> Thông tin mua hàng </h4>
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="checkout-form-list">
                                        ...
                                        <input type="text" name="shipping_phone" class="shipping_phone" placeholder="Nhập số điện thoại">
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="checkout-form-list">
...
{{--                                </div>--}}
                                <div class="col-md-12 order-notes">
                                    <div class="checkout-form-list">
                                        <label>Ghi chú gửi hàng<span class="required">*</span></label>
                                        <textarea id="checkout-mess" name="shipping_notes" class="shipping_notes" cols="30" rows="10" placeholder="Ghi chú về đơn đặt hàng của bạn, ví dụ: lưu ý đặc biệt để giao hàng."></textarea>
                                    </div>
                                </div>
                                <div class="checkbox-form">
...
{{--                                        @endphp--}}
                                        <div class="col-md-12">
                                            <div class="checkout-form-list" id="paypal-button">
                                                {{--tạo input ko hiển thị kiểu type="hidden" value mang giá trị là {round($vnd_to_usd,2)}}  phẩy (,) 2 là làm tròn 2 chữ số --}}
                                                <input type="hidden" id="vnd_to_usd"
{{--                                                       value="{{round($vnd_to_usd,2)}}"--}}
                                                >
                                                {{--                                        <label>Họ và tên <span class="required">*</span></label>--}}
                                                <label><input name="payment_select" class="payment_select" value="0" type="checkbox">Thanh toán online bằng Ví điện tử  <span class="required"><h4><i style="color: #479bf3" class="fa fa-cc-paypal"></i></h4></span> </label>
                                            </div>
{{--                                            <div c>--}}
...
{{--                                            </div>--}}
                                        ...
                                        <div class="col-md-12">
                                            <div class="checkout-form-list">
                                                <label><input name="payment_select" value="1" type="checkbox">Giao hàng và thu tiền tại nhà </label>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            {{--                                    <div class="checkout-form-list">--}}
                                ...
                                <div  class="col-md-6 order-button-payment">
                                     <input type="button" style="margin-left: 120px; margin-bottom: 5px; margin-top: 3px"  value="Gửi đơn Hàng"  name="send_order" class="send_order">
