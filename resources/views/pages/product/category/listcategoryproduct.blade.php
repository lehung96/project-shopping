...
{{--                    <li class="active">Máy hút bụi gia đình</li>--}}
{{--                </ul>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
...
{{--                                <span>Hiển thị {{count($category_products)}}  Sản phẩm</span>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                    <div class="row">--}}
{{--                                        @foreach($category_products as $cate_product)--}}
...
{{--                                                        <img class="product_image_218_218" src="{{URL::to('public/uploads/products/'.$cate_product->image)}}" alt="Li's Product Image">--}}
{{--                                                    </a>--}}
...
{{--                                                            </div>--}}
{{--                                                        </div>--}}
{{--                                                        <h4><a class="product_name" href="single-product.html">{{ $cate_product->product_name}}</a></h4>--}}
{{--                                                        <div class="price-box">--}}
{{--                                                            <span class="new-price">{{ number_format($cate_product->price) }} VNĐ</span>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
