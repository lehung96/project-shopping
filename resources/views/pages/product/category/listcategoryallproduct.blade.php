...
{{--                                <span>Hiển thị {{count($category_allproduct)}}  Sản phẩm</span>--}}
{{--                            </div>--}}
{{--                        </div>--}}
...
{{--                                    <div class="row">--}}
{{--                                        @foreach($category_allproduct as $cate_allproduct)--}}
...
{{--                                                        <img class="product_image_218_218" src="{{URL::to('public/uploads/products/'.$cate_allproduct->image)}}" alt="Li's Product Image">--}}
{{--                                                    </a>--}}
...
{{--                                                            </div>--}}
{{--                                                        </div>--}}
{{--                                                        <h4><a class="product_name" href="single-product.html">{{ $cate_allproduct->product_name}}</a></h4>--}}
{{--                                                        <div class="price-box">--}}
{{--                                                            <span class="new-price">{{ number_format($cate_allproduct->price) }} VNĐ</span>--}}
{{--                                                        </div>--}}
{{--                                                    </div>--}}
{{--                                                    <div class="add-actions">--}}
{{--                                                        <ul class="add-actions-link">--}}
{{--                                                            <li class="add-cart active"><a href="#" class="add_to_cart">Add to cart</a></li>--}}
...
{{--                                        <li><input type="checkbox" name="product-categori"><a href="#">Electronics</a></li>--}}
{{--                                    </ul>--}}
{{--                                </form>--}}
{{--                            </div>--}}
{{--                        </div>--}}
